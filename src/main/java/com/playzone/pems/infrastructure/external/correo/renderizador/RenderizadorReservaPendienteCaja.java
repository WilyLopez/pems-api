...
public class RenderizadorReservaPendienteCaja implements RenderizadorCorreoTransaccional {
    ...
    public ContenidoCorreo renderizar(Notificacion notificacion) {
        ...
        String cuerpoHtml = templateService.procesarTemplate("email-reserva-pendiente-caja", variables);

        return ContenidoCorreo.builder()
                .destinatario(reserva.getCorreoCliente())
                .asunto("Reserva registrada — paga en caja — Kiki y Lala")
