...
public class RenderizadorSolicitudEvento implements RenderizadorCorreoTransaccional {
    ...
    public String tipoCodigo() {
        return "EVENTO_PRESUPUESTO_ENVIADO";
    }
    ...
    public ContenidoCorreo renderizar(Notificacion notificacion) {
        ...
        String cuerpoHtml = templateService.procesarTemplate("email-evento-solicitud", variables);

        return ContenidoCorreo.builder()
                .destinatario(cliente.getCorreo())
                .asunto("Tu cotización está lista — Kiki y Lala")
